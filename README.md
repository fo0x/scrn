...
2. Використовуй `npm run build` (в цьому репо: clean tsbuildinfo/cache -> vite build).
...
7. Typecheck запускай окремо (`npm run typecheck`) — це корисно для CI quality gate, але не блокує production bundle.
